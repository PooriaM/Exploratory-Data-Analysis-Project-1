...
par(mfrow=c(2,2))
plot(data1$DateTime, data1$Global_active_power, xlab = '', ylab = 'Global Active Power', type = 'l')
...
plot(data1$DateTime, data1$Global_reactive_power, xlab = 'datetime', ylab = 'Global_reactive_power', type = 'l', ylim=c(0,0.5))
dev.off()
